...
You are bootstrapping the Faber wiki at `wiki/` by processing existing vault content. Read `wiki/FABER.md` for conventions.
...
3. **`concepts/*.md`** — Validated concepts with research
4. **`ideas/*.md`** — Raw ideas (skip status: killed)
...
8. **`Clippings/*.md`** — Web-clipped articles
