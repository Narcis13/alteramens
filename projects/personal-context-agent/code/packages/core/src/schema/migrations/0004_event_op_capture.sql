-- Extend events.operation CHECK with 'capture' and 'capture-update'.
-- SQLite cannot ALTER a CHECK constraint; rebuild the table per the pattern
-- in 0002_link_invalidate_op.sql.
